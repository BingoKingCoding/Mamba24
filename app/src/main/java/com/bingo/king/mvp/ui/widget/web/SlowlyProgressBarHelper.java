...
/**
 * <请描述这个类是干什么的>
 * Created by wang on 2017/11/23 11:24.
 */

public class SlowlyProgressBarHelper
{
     ...
     * 第一种
     */
    public SlowlyProgressBarHelper(View view, int phoneWidth)
    {
        initHandler();
     ...
     * 第二种
     */
    public SlowlyProgressBarHelper(ProgressBar progressBar)
    {
    ...
    public SlowlyProgressBarHelper setViewHeight(int height)
    {
        this.height = height;
        return this;
    }
